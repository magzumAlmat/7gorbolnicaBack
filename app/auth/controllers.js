...
const logOut = async (req, res) => {
    // Here you can add additional logic if needed, such as logging the user out from all devices, etc.
    // For a basic logout, you may simply respond with a success message.
